    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col">
            ...
            <form class="row">
                <legend class="mt-5">Informacion del curso</legend>
                <div class="col-md-3">
                    <div class="mb-3">
                        <label for="nombresUsuario" class="form-label">Curso:</label>
                        <input type="text" class="form-control" id="nombresUsuario">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="mb-3">
                        <label for="apellidosUsuario" class="form-label">Descripcion del curso:</label>
